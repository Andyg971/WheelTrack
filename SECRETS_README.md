...
**NE JAMAIS** inclure de vraies clés API dans les fichiers commités dans Git.
Toutes les clés API doivent être stockées uniquement dans `Secrets.plist` qui est ignoré par Git.
